...
These scripts also support volumetric data sets with no explicit segmentation. An example is the [H5J format](https://github.com/JaneliaSciComp/workstation/blob/master/docs/H5JFileFormat.md) volumes in the [Janelia FlyLight Split-GAL4 driver collection](https://splitgal4.janelia.org/cgi-bin/splitgal4.cgi).  This kind of data is rendered with direct volume rendering by [VVDViewer](https://github.com/takashi310/VVD_Viewer).
