...
5. Run the script to read the clipboard and output the JSON file that specifies the video:
...
5. Run the script to convert the Neuroglancer URL in the clipboard into the JSON file that specifies the video:
...
3. Run the last four `neuVid` script as above:
...
6. Run the last four `neuVid` script as above:
