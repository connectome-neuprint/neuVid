...
parser.add_argument("--samples", "-sa", dest="numSamples", help="number of samples per pixel for the Octane renderer")
...
# TODO: A step of other than 1 is not handled correctly with the rest intervals.
if args.step != None:
